...
Il est difficile de se protéger contre le suivi numérique et le suivi du navigateur sans utiliser le navigateur Tor, mais vous pouvez encore faire beaucoup de choses. Utilisez les navigateurs mentionnés ci-dessus, modifiez vos paramètres de confidentialité et [testez ici](https://coveryourtracks.eff.org/) afin de déterminer si votre navigateur envoie des informations uniques et identifiables comme l’“empreinte digitale du navigateur" aux pages web que vous visitez !
