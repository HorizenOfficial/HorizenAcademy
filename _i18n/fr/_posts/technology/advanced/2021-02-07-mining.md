...
L'une des propriétés importantes des fonctions de hachage cryptographiques est d'être pseudo-aléatoire. Vous ne devez pas être en mesure de prédire une modification de la sortie résultant d'une modification de l'entrée. A titre d'exemple : Si vous hachez l'entrée "1" et obtenez la sortie "00002" et hachez l'entrée "2" par la suite, la deuxième sortie a intérêt à ne pas être "00004" mais quelque chose comme "73968", un nombre (pseudo-aléatoire) apparemment aléatoire.
...
![Hash function](/assets/post_files/technology/advanced/mining/FR_hash_function_D.jpg)
![Hash function](/assets/post_files/technology/advanced/mining/FR_hash_function_M.jpg)
