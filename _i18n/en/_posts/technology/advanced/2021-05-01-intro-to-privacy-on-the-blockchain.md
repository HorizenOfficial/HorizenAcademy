...
For this article, we assume that you are familiar with the UTXO model that many blockchains use for accounting. If you are not, feel free to check out [our article]({{ site.baseurl }}{% post_url technology/advanced/2021-04-02-the-utxo-model.md %}) on it before you continue reading.
