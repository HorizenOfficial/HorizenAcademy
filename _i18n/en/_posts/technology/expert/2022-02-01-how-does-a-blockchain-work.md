...
<div class="row mt-5">
    <div class="col-md-3">
        <a href="{{ site.baseurl }}{% post_url /technology/expert/2022-02-04-0-public-key-cryptography %}">
            <img src="{{site.baseurl_root}}/assets/post_files/technology/expert/2.0-how-does-it-work/pkc.svg" alt="Public Key Cryptography" />
        </a>
    </div>
    <div class="col-md-9">
...
<div class="row mt-5">
    <div class="col-md-3">
        <a href="{{ site.baseurl }}{% post_url /technology/expert/2022-02-05-0-consensus-mechanisms %}">
            <img src="{{site.baseurl_root}}/assets/post_files/technology/expert/2.0-how-does-it-work/consensus_4.svg" alt="Consensus Mechanisms" />
        </a>
    </div>
    <div class="col-md-9">
...
<div class="row mt-5">
    <div class="col-md-3">
        <a href="{{ site.baseurl }}{% post_url /technology/expert/2022-02-08-blockchain-governance %}">
            <img src="{{site.baseurl_root}}/assets/post_files/technology/expert/2.0-how-does-it-work/governance_7.svg" alt="Blockchain Governance" />
        </a>
    </div>
    <div class="col-md-9">
