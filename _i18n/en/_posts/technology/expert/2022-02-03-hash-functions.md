...
Cryptographic hash functions must possess all properties described in the last section, one-wayness, pseudo-randomness, collision resistance and deterministic. The functions require a large output space in order to achieve all the described properties.
