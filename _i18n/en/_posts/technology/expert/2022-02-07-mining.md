...
+++++ graphic selfish mining 0 dash

State 0' is a little more interesting. The selfish miner still has the chance of winning the competition between block *1* and *1'*. As soon as he becomes aware of block *1* being broadcast he will broadcast his version (*1'*) to the network. At this point there is a tie but block *1* has an advantage. Most miners will have received block *1* first and 
