...
dancing on a scale between centralization and decentralization. no absolutes. but certain developments represent centralizing or decentralizing factors. **TKKG**
...
Besides using sophisticated and specialized hardware mining has professionalized in other ways. Economoic principles known for decades and centuries increasingly started to apply to this field.
...
[BetterHash](https://github.com/TheBlueMatt/bips/blob/betterhash/bip-XXXX.mediawiki) addresses this issue by allowing individual miners to create their own block templates.
