...
- The *Nonce* - or *n*umber used *once* - is the variable that miners change to modify the block headers hash for its value to meet the difficulty. This process is covered in detail in our article on [mining]({{ site.baseurl }}{% post_url /technology/expert/2022-02-07-mining %}).
