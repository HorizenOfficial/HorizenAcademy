...
Ideally, backward transfers are objectively verifiable without the need to rely on intermediaries. This is the reason Horizen built a backward transfer mechanism relying on a proof system rather than human entities.
