...
<div class="row mt-5">
    ...
    <div class="col-md-9">
        ...
        <p class="mb-1">
            In order to receive, store and send cryptocurrencies, one uses a cryptocurrency wallet. In the third chapter, we will explain to you how such wallets work.
        </p>
        <p class="mb-0">
