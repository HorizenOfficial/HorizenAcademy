...
¿Por qué no prueba ZenChat usted mismo? Descargue nuestra aplicación insignia, [Sphere by Horizen](https://www.horizen.global/spherebyhorizen/), active el modo completo en los ajustes y envíe su primer mensaje. Si aún no cuenta con ZEN, visite nuestra [Fuente ZEN](https://getzen.cash/) para recibir gratis algunas monedas y empezar a explorar.
